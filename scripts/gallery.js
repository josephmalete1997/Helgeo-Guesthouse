...
const units = [{
        ...
        photos: [
            '../gallery/unit1/a8.jpg',
            '../gallery/unit1/a1.jpg',
            '../gallery/unit1/a2.jpg',
            '../gallery/unit1/a3.jpg',
            '../gallery/unit1/a4.jpg',
            '../gallery/unit1/a5.jpg',
            '../gallery/unit1/a6.jpg',
            '../gallery/unit1/a7.jpg',
        ],
    ...
    },
    {
        ...
        photos: [
            '../gallery/unit2/b1.jpg',
            '../gallery/unit2/b2.jpg',
            '../gallery/unit2/b3.jpg',
            '../gallery/unit2/b4.jpg',
            '../gallery/unit2/b5.jpg',
            '../gallery/unit2/b6.jpg',
            '../gallery/unit2/b7.jpg',
            '../gallery/unit2/b8.jpg',
            '../gallery/unit2/b9.jpg',
            '../gallery/unit2/b10.jpg',
        ],
        catering: 'Standard',
        price: 450,
        floorPlan: `../plans/two-sleeper(SC)Mobile.png`
    },
    {
        ...
        photos: [
            '../gallery/unit3/c1.jpg',
            '../gallery/unit3/c2.jpg',
            '../gallery/unit3/c3.jpg',
            '../gallery/unit3/c4.jpg',
            '../gallery/unit3/c5.jpg',
            '../gallery/unit3/c6.jpg',
            '../gallery/unit3/c7.jpg',
        ],
        catering: 'Self-Catering',
        price: 1200,
    ...
    },
    {
        ...
        photos: [
            '../gallery/unit4/d1.jpg',
            '../gallery/unit4/d3.jpg',
            '../gallery/unit4/d2.jpg',
            '../gallery/unit4/d4.jpg',
            '../gallery/unit4/d5.jpg',
            '../gallery/unit4/d6.jpg',
            '../gallery/unit4/d7.jpg',
            '../gallery/unit4/d8.jpg',
            '../gallery/unit4/d9.jpg',
            '../gallery/unit4/d10.jpg',
        ],
        catering: 'Self-Catering',
        price: 1800,
